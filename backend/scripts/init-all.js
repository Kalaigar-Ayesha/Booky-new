// Script to initialize the database with sample data and test users
// Run with: node scripts/init-all.js
...
const sampleBooks = [
  ...
  },
  {
    ...
    cover_url: 'https://images-na.ssl-images-amazon.com/images/I/81g6BKT75HL.jpg',
    description: 'An adventure fantasy novel about a hobbit named Bilbo Baggins.',
  ...
  },
  {
    ...
    cover_url: 'https://images-na.ssl-images-amazon.com/images/I/91T0y7gTL8L.jpg',
...
const testUsers = [
  ...
  },
  {
    ...
    password: 'demo123456',
    username: 'demouser',
    bio: 'Testing out Booksy with various books.',
  },
  {
...
async function initializeDatabase() {
  try {
    ...
    if (existingBooks === 0) {
      ...
      console.log(`ℹ️  Database already has ${existingBooks} books. Skipping book initialization.`);
    }
